# CLAUDE.md — favico × Bitwarden

Shared context for Claude Code and Claude Cowork. This is the **local, guided
...
- Plain claude.ai chats and design chats can't write to that file — paste their
